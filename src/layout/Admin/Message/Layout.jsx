...
const Layout = () => {
    ...
    return (
        <div className='flex flex-col w-[100vw] min-h-[100vh] max-h-fit overflow-y-auto bg-[#0d2539]'>
            ...
            <div className='pt-[10.3rem] flex justify-between items-start md:flex-row flex-col bg-darkBlue md:px-[2rem] flex-1 h-[fit] md:h-[86rem] w-[100vw] gap-x-6'>
                        ...
                        <div className='flex-1 p-2 bg-[#0d2539] rounded-md'>
                            {selectedFriend ? (
                                ...
                                <div className='flex flex-col items-center justify-center'>
                                    <p className='text-white text-lg'>Select a user to start a conversation.</p>
                                </div>
                            )}
                        </div>
