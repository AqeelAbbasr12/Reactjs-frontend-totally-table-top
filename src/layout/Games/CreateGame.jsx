          ...
          <div className="flex justify-center items-center md:flex-row flex-col mt-2 gap-x-4 pb-2">
            <div className="flex justify-between relative rounded-md w-[100%]">
              <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                <span className="text-gray-500 text-white">$</span>
              </div>
              <input
                type="text"
                name="price"
            ...
            >
              ...
              {isOpen && (
                <ul
                  className="mt-2 bg-darkBlue top-[415px] rounded-md text-white absolute z-10 origin-top-right"
                  tabindex="-1"
                >
