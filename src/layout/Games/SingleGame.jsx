                ...
                <div className='flex-1'>
                    ...
                    {game.user_id !== currentUserId && (
                        <div className="mt-4 flex gap-x-2 items-center">
                            ...
                            >
                                <IoMdFlag
                                    size={34} // Customize the icon size
                                    color="#F77F00" // Customize the icon color
                                    className="cursor-pointer"
                                    onClick={() => handleReportGame(game.id)} // Dynamic game ID
                                />

                                {/* Hover Pop-up Card */}
                                {showPopup && (
                                    <div className="absolute bottom-[120%] left-8 sm:left-1 transform -translate-x-1/3 sm:-translate-x-[18.333333%] w-[150px] bg-white p-2 rounded-md shadow-lg z-10 mt-2">
                                        <p className="text-black text-center">Report a Game</p>
                                    </div>
