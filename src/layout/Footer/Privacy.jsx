          ...
          <div className="">
            ...
            <div className="mb-4">
              ...
              <p className="text-white  mb-2 w-[100%] md:w-[80%]">
                ...
                <span className="text-f3c15f">www.totallytabletop.com</span>
              </p>
              <p className="text-white  mb-2 w-[100%] md:w-[80%]">
            ...
            <p className="text-white  mb-4 w-[100%] md:w-[80%]">
              ...
              <span className="text-f3c15f">cookie policy.</span>
            </p>
            ...
            <p className="text-white mb-4 w-[100%] md:w-[80%]">
              You can {" "}
              <span className="text-f3c15f">contact us using this website</span>{" "}
